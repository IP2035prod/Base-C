...
int main()
{
    ...
    else if (KolNechet >= KolChet)  //ИСПРАВЛЕНИЕ №1: Невнимательно прочитал условие: добавил "больше или равно" вместо "больше".
    {
    ...
    //else if (KolChet == KolNechet) //ИСПРАВЛЕНИЕ №1: Невнимательно прочитал условие: убрал лишнюю ветку. 
    //{
